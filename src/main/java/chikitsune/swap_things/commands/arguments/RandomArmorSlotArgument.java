...
public class RandomArmorSlotArgument implements ArgumentType<String> {
 ...
 private static final DynamicCommandExceptionType NOT_IN_LIST = new DynamicCommandExceptionType((msg) -> { return new TranslatableComponent("arguments.randomarmorslot.notFound", msg); });
 
 public static RandomArmorSlotArgument allArmorSlots() { return new RandomArmorSlotArgument(); }
 
 public static String getRandomArmorSlot(CommandContext<CommandSourceStack> context, String name) throws CommandSyntaxException {

...
public class RandomArmorSlotArgument implements ArgumentType<String> {
 ...
 private static final DynamicCommandExceptionType NOT_IN_LIST = new DynamicCommandExceptionType((msg) -> { return Component.translatable("arguments.randomarmorslot.notFound", msg); });
